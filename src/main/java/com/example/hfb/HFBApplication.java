...
public class HFBApplication {
    ...
    CommandLineRunner runner(SeedingService service) {
        return args -> {
            ...
            service.deleteDonations();
            service.resetIdDonation();
            ...
            service.saveFood(new Food(1, "Trà sữa", "v1636265587/hanoi_food_bank_project/uploaded_food/Drinks/trasua1_hodocl.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-21"), Utilities.convertStringToLong("2022-08-11"), Utilities.convertStringToLong("2022-08-01"), 4, 4,
            ...
            service.saveFood(new Food(2, "Nước ép trái cây", "v1636266037/hanoi_food_bank_project/uploaded_food/Drinks/nuocep_fgftoc.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-21"), Utilities.convertStringToLong("2022-08-11"), Utilities.convertStringToLong("2022-08-02"), 4, 4,
                    service.findByCategoryId(1),
                    1)
            );
            service.saveFood(new Food(3, "Nước ép rau má", "v1636267616/hanoi_food_bank_project/uploaded_food/Drinks/rauma1_u1z0ar.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-21"), Utilities.convertStringToLong("2022-08-11"), Utilities.convertStringToLong("2022-08-03"), 4, 4,
                    service.findByCategoryId(1),
                    1)
            );
            service.saveFood(new Food(4, "Chè thập cẩm", "v1636267824/hanoi_food_bank_project/uploaded_food/Drinks/chethapcam_tmcqbj.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-21"), Utilities.convertStringToLong("2022-08-11"), Utilities.convertStringToLong("2022-08-04"), 4, 4,
                    service.findByCategoryId(1),
                    1)
            );
            service.saveFood(new Food(5, "Trà chanh", "v1636268040/hanoi_food_bank_project/uploaded_food/Drinks/trachanh_m6ywid.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-21"), Utilities.convertStringToLong("2022-08-10"), Utilities.convertStringToLong("2022-08-05"), 4, 4,
                    service.findByCategoryId(1),
                    1)
            );
            service.saveFood(new Food(6, "Cafe", "v1636268227/hanoi_food_bank_project/uploaded_food/Drinks/cafe1_u1fnuv.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-21"), Utilities.convertStringToLong("2022-08-10"), Utilities.convertStringToLong("2022-08-06"), 4, 4,
                    service.findByCategoryId(1),
                    1)
            );
            service.saveFood(new Food(7, "Sinh tố trái cây", "v1636268371/hanoi_food_bank_project/uploaded_food/Drinks/sinhto1_ogfaph.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-21"), Utilities.convertStringToLong("2022-08-10"), Utilities.convertStringToLong("2022-08-07"), 4, 4,
                    service.findByCategoryId(1),
                    1)
            );
            service.saveFood(new Food(8, "Dâu tây kem đá xay", "v1636268570/hanoi_food_bank_project/uploaded_food/Drinks/daxay1_a7zor3.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-21"), Utilities.convertStringToLong("2022-08-08"), Utilities.convertStringToLong("2022-08-08"), 4, 4,
                    service.findByCategoryId(1),
                    1)
            );
            service.saveFood(new Food(9, "Trà dâu ", "v1636268883/hanoi_food_bank_project/uploaded_food/Drinks/tradau_akvtqo.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-21"), Utilities.convertStringToLong("2022-08-09"), Utilities.convertStringToLong("2022-08-09"), 4, 4,
                    service.findByCategoryId(1),
                    1)
            );
            service.saveFood(new Food(10, "Sữa đậu nành", "v1636268998/hanoi_food_bank_project/uploaded_food/Drinks/suadau_majfsi.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-21"), Utilities.convertStringToLong("2022-08-10"), Utilities.convertStringToLong("2022-08-10"), 4, 4,
                    service.findByCategoryId(1),
                    1)
            );
            ...
            service.saveFood(new Food(14, "Phở cuốn", "v1636248386/hanoi_food_bank_project/uploaded_food/Noodle/phocuon_xn6r2l.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-21"), Utilities.convertStringToLong("2022-08-10"), Utilities.convertStringToLong("2022-08-08"), 4, 4,
                    service.findByCategoryId(2),
                    2)
            );
            service.saveFood(new Food(15, "Bún riêu bề bề", "v1636248383/hanoi_food_bank_project/uploaded_food/Noodle/bunrieubebe_nvviro.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-21"), Utilities.convertStringToLong("2022-08-11"), Utilities.convertStringToLong("2022-08-09"), 4, 4,
                    service.findByCategoryId(2),
                    2)
            );
            service.saveFood(new Food(16, "Bún cá", "v1636248323/hanoi_food_bank_project/uploaded_food/Noodle/bunca_j8gmpc.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-21"), Utilities.convertStringToLong("2022-08-11"), Utilities.convertStringToLong("2022-08-10"), 4, 4,
                    service.findByCategoryId(2),
                    2)
            );
            service.saveFood(new Food(17, "Phở bò", "v1636248385/hanoi_food_bank_project/uploaded_food/Noodle/phobo_scqxt7.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-23"), Utilities.convertStringToLong("2022-08-11"), Utilities.convertStringToLong("2022-08-11"), 4, 4,
                    service.findByCategoryId(2),
                    2)
            );
            service.saveFood(new Food(18, "Bún thang", "v1636248385/hanoi_food_bank_project/uploaded_food/Noodle/bunthang_sgrcce.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-21"), Utilities.convertStringToLong("2022-08-11"), Utilities.convertStringToLong("2022-08-11"), 4, 4,
                    service.findByCategoryId(2),
                    2)
            );
            service.saveFood(new Food(19, "Mì ý", "v1636248384/hanoi_food_bank_project/uploaded_food/Noodle/myy_vevfde.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-21"), Utilities.convertStringToLong("2022-08-11"), Utilities.convertStringToLong("2022-08-13"), 4, 4,
                    service.findByCategoryId(2),
                    2)
            );
            service.saveFood(new Food(20, "Mì tương đen", "v1636248384/hanoi_food_bank_project/uploaded_food/Noodle/mituongden_zxsiua.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-21"), Utilities.convertStringToLong("2022-08-11"), Utilities.convertStringToLong("2022-14-10"), 4, 4,
                    service.findByCategoryId(2),
                    2)
            );
            ...
            service.saveFood(new Food(21, "Bánh mỳ heo quay", "v1636274435/hanoi_food_bank_project/uploaded_food/Bread/banhmykepthi_hjlftf.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-22"), Utilities.convertStringToLong("2022-08-09"), Utilities.convertStringToLong("2022-08-02"), 4, 4,
            ...
            service.saveFood(new Food(22, "Bánh mỳ Doner Kebab", "v1636274548/hanoi_food_bank_project/uploaded_food/Bread/doner_audpfx.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-22"), Utilities.convertStringToLong("2022-08-09"), Utilities.convertStringToLong("2022-08-03"), 4, 4,
                    service.findByCategoryId(3),
                    3)
            );
            service.saveFood(new Food(23, "Bánh mỳ sốt vang", "v1636274713/hanoi_food_bank_project/uploaded_food/Bread/banhmiotvang1_l1isew.jpg",
                    ...
                    "đậm đà hương vị", "5 suất cho những chiếc bụng đói",
                    Utilities.convertStringToLong("2022-08-22"), Utilities.convertStringToLong("2022-08-09"), Utilities.convertStringToLong("2022-08-04"), 4, 4,
                    service.findByCategoryId(3),
                    3)
            );
            ...
            service.saveFood(new Food(25, "Bánh mỳ nướng Lạng Sơn", "v1636277512/hanoi_food_bank_project/uploaded_food/Bread/banhmynuong1_vylmr8.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-22"), Utilities.convertStringToLong("2022-08-09"), Utilities.convertStringToLong("2022-08-05"), 4, 4,
                    service.findByCategoryId(3),
                    3)
            );
            service.saveFood(new Food(26, "Bánh mỳ que", "v1636277646/hanoi_food_bank_project/uploaded_food/Bread/banhmyque_hsn1ga.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-23"), Utilities.convertStringToLong("2022-08-08"), Utilities.convertStringToLong("2022-08-06"), 4, 4,
                    service.findByCategoryId(3),
                    3)
            );
            service.saveFood(new Food(27, "Pizza", "v1636277830/hanoi_food_bank_project/uploaded_food/Bread/pizza_sdhvi4.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-23"), Utilities.convertStringToLong("2022-08-08"), Utilities.convertStringToLong("2022-08-07"), 4, 4,
                    service.findByCategoryId(3),
                    3)
            );
            service.saveFood(new Food(28, "Bánh bông lan trứng muối", "v1636277977/hanoi_food_bank_project/uploaded_food/Bread/bonglantrungmuoi_ildfpb.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-23"), Utilities.convertStringToLong("2022-08-08"), Utilities.convertStringToLong("2022-08-08"), 4, 4,
                    service.findByCategoryId(3),
                    3)
            );
            service.saveFood(new Food(29, "Bánh cupcake", "v1636278414/hanoi_food_bank_project/uploaded_food/Bread/banhkem_fajzjl.jpg",
                    ...
                    "hương vị châu âu", "nhanh tay chỉ trong tối nay",
                    Utilities.convertStringToLong("2022-08-23"), Utilities.convertStringToLong("2022-08-09"), Utilities.convertStringToLong("2022-08-09"), 4, 4,
                    service.findByCategoryId(3),
                    3)
            );
            service.saveFood(new Food(30, "Bánh sừng bò", "v1636278650/hanoi_food_bank_project/uploaded_food/Bread/banhsungbo_m9vj06.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-22"), Utilities.convertStringToLong("2022-08-10"), Utilities.convertStringToLong("2022-08-10"), 4, 4,
                    service.findByCategoryId(3),
                    3)
            );
            ...
            service.saveFood(new Food(31, "Cơm gà chiên nước mắm", "v1636269287/hanoi_food_bank_project/uploaded_food/Rice/comganuocmam_shcxyn.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-21"), Utilities.convertStringToLong("2022-08-10"), Utilities.convertStringToLong("2022-09-29"), 4, 4,
            ...
            service.saveFood(new Food(32, "Cơm tấm", "v1636269444/hanoi_food_bank_project/uploaded_food/Rice/comtam_ghewsm.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-21"), Utilities.convertStringToLong("2022-08-10"), Utilities.convertStringToLong("2022-08-01"), 4, 4,
                    service.findByCategoryId(4),
                    4)
            );
            service.saveFood(new Food(33, "Cơm rang", "v1636269710/hanoi_food_bank_project/uploaded_food/Rice/conrang_gnhoer.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-21"), Utilities.convertStringToLong("2022-08-10"), Utilities.convertStringToLong("2022-08-02"), 4, 4,
                    service.findByCategoryId(4),
                    4)
            );
            service.saveFood(new Food(34, "Cơm văn phòng", "v1636269956/hanoi_food_bank_project/uploaded_food/Rice/comvanphong1_b9ej19.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-21"), Utilities.convertStringToLong("2022-08-09"), Utilities.convertStringToLong("2022-08-03"), 4, 4,
                    service.findByCategoryId(4),
                    4)
            );
            service.saveFood(new Food(35, "Cơm thố", "v1636270153/hanoi_food_bank_project/uploaded_food/Rice/comtho_whwlwa.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-21"), Utilities.convertStringToLong("2022-08-09"), Utilities.convertStringToLong("2022-08-04"), 4, 4,
                    service.findByCategoryId(4),
                    4)
            );
            service.saveFood(new Food(36, "Cơm trộn", "v1636270259/hanoi_food_bank_project/uploaded_food/Rice/comtron1_csc9ez.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-21"), Utilities.convertStringToLong("2022-08-09"), Utilities.convertStringToLong("2022-08-05"), 4, 4,
                    service.findByCategoryId(4),
                    4)
            );
            service.saveFood(new Food(37, "Cơm cuộn", "v1636270462/hanoi_food_bank_project/uploaded_food/Rice/comcuon1_nahocj.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-21"), Utilities.convertStringToLong("2022-08-09"), Utilities.convertStringToLong("2022-08-06"), 4, 4,
                    service.findByCategoryId(4),
                    4)
            );
            ...
            service.saveFood(new Food(39, "Cơm chay", "v1636270886/hanoi_food_bank_project/uploaded_food/Rice/comchay_znw61z.jpg",
                    ...
                    Utilities.convertStringToLong("2022-08-21"), Utilities.convertStringToLong("2022-08-09"), Utilities.convertStringToLong("2022-08-08"), 4, 4,
                    service.findByCategoryId(4),
                    4)
            );
...
//            service.saveRequest(2, 9, "help", "2022-08-11", "2022-08-11");
...
//            service.saveRequest(2, 46, "món này ngon quá", "2022-08-11", "2022-08-11");
//            service.saveRequest(3, 47, "cho em xin món này đi đại ca", "2022-08-11", "2022-08-11");
//
//            service.saveRequest(2, 81, "em xin", "2022-08-02", "2022-08-02");
//            service.saveRequest(3, 81, "anh ơi cho em xin món này", "2022-08-02", "2022-08-02");
//
//            service.saveRequest(2, 82, "cho em xin món này", "2022-08-03", "2022-08-03");
//            service.saveRequest(3, 82, "em xin", "2022-08-03", "2022-08-03");
//
//            service.saveRequest(2, 83, "món này ngon quá", "2022-08-04", "2022-08-04");
//            service.saveRequest(3, 83, "em xin với ạ", "2022-08-04", "2022-08-04");
//
//            service.saveRequest(2, 84, "em xin cho bữa tối ạ", "2022-08-05", "2022-08-05");
//            service.saveRequest(3, 84, "em cho bé bán vé số ạ", "2022-08-05", "2022-08-05");
//
//            service.saveRequest(2, 85, "help", "2022-08-06", "2022-08-06");
//            service.saveRequest(3, 85, "em xin với ạ", "2022-08-06", "2022-08-06");
//
//            service.saveRequest(2, 86, "cho em xin bữa này với ạ", "2022-08-07", "2022-08-07");
//            service.saveRequest(3, 86, "nhìn ngon quá cho em xin món này vs ạ", "2022-08-07", "2022-08-07");
//
//            service.saveRequest(2, 87, "món này ngon quá", "2022-08-08", "2022-08-08");
//            service.saveRequest(3, 87, "em xin với ạ", "2022-08-08", "2022-08-08");
//
//            service.saveRequest(2, 88, "món này ngon quá", "2022-08-09", "2022-08-09");
//            service.saveRequest(3, 88, "cho em xin món này đi đại ca", "2022-08-09", "2022-08-09");
//
//            service.saveRequest(2, 89, "cho em xin bữa này với ạ", "2022-08-10", "2022-08-10");
//            service.saveRequest(3, 89, "em xin với ạ", "2022-08-10", "2022-08-10");
//
//            service.saveRequest(2, 90, "món này ngon quá", "2022-08-07", "2022-08-07");
//            service.saveRequest(3, 90, "cho em xin món này đi đại ca", "2022-08-07", "2022-08-07");
//
//            service.saveRequest(2, 91, "món này ngon quá", "2022-08-03", "2022-08-03");
//            service.saveRequest(3, 91, "cho em xin món này đi đại ca", "2022-08-03", "2022-08-03");
//
//            service.saveRequest(2, 92, "cho em xin bữa này với ạ", "2022-08-04", "2022-08-04");
//            service.saveRequest(3, 92, "em xin với ạ", "2022-08-04", "2022-08-04");
//
//            service.saveRequest(2, 93, "món này ngon quá", "2022-08-05", "2022-08-05");
//            service.saveRequest(3, 93, "em xin với ạ", "2022-08-05", "2022-08-05");
//
//            service.saveRequest(2, 94, "cho em xin bữa này với ạ", "2022-08-07", "2022-08-07");
//            service.saveRequest(3, 94, "cho em xin món này đi đại ca", "2022-08-07", "2022-08-07");
//
//            service.saveRequest(2, 95, "món này ngon quá", "2022-08-08", "2022-08-08");
//            service.saveRequest(3, 95, "em xin với ạ", "2022-08-08", "2022-08-08");
//
//            service.saveRequest(2, 96, "cho em xin bữa này với ạ", "2022-08-08", "2022-08-08");
//            service.saveRequest(3, 96, "cho em xin món này đi đại ca", "2022-08-08", "2022-08-08");
//
//            service.saveRequest(2, 97, "cho em xin bữa này với ạ", "2022-08-03", "2022-08-03");
//            service.saveRequest(3, 97, "nhìn ngon quá cho em xin món này vs ạ", "2022-08-03", "2022-08-03");
//
//            service.saveRequest(2, 98, "cho em xin bữa này với ạ", "2022-08-08", "2022-08-08");
//            service.saveRequest(3, 98, "cho em xin món này đi đại ca", "2022-08-08", "2022-08-08");
//
//            service.saveRequest(2, 99, "món này ngon quá", "2022-08-04", "2022-08-04");
//            service.saveRequest(3, 99, "em xin với ạ", "2022-08-04", "2022-08-04");
//
//            service.saveRequest(2, 100, "cho em xin bữa này với ạ", "2022-08-03", "2022-08-03");
//            service.saveRequest(3, 100, "nhìn ngon quá cho em xin món này vs ạ", "2022-08-04", "2022-08-04");
//
//            service.saveRequest(2, 101, "nhìn ngon quá cho em xin món này vs ạ", "2022-08-21", "2022-08-21");
//            service.saveRequest(3, 101, "nhìn ngon quá", "2022-08-11", "2022-08-11");
//
//            service.saveRequest(2, 102, "món này ngon quá", "2022-08-11", "2022-08-11");
//            service.saveRequest(3, 102, "cho em xin bữa này với ạ", "2022-08-11", "2022-08-11");
//
//            service.saveRequest(2, 103, "món này ngon quá", "2022-08-10", "2022-08-10");
//            service.saveRequest(3, 103, "em xin với ạ", "2022-08-11", "2022-08-11");
//
//            service.saveRequest(2, 104, "nhìn ngon quá cho em xin món này vs ạ", "2022-08-10", "2022-08-10");
//            service.saveRequest(3, 104, "em xin với ạ", "2022-08-10", "2022-08-10");
//
//            service.saveRequest(2, 105, "nhìn ngon quá cho em xin món này vs ạ", "2022-08-08", "2022-08-08");
//            service.saveRequest(3, 105, "cho em xin bữa này với ạ", "2022-08-08", "2022-08-08");
//
//            service.saveRequest(2, 106, "món này ngon quá", "2022-08-08", "2022-08-08");
//            service.saveRequest(3, 106, "nhìn ngon quá cho em xin món này vs ạ", "2022-08-08", "2022-08-08");
//
//            // Feedback
