...
//            service.resetIdCategory();
           ...
           // add user
            service.saveUser(new User(1, "admin", "admin@gmail.com", "123", "admin@gmail.com", "09061234", "Ha noi", "", 100, datetime, datetime, 1, 1, 1));
            ...
            service.saveUser(new User(3, "A", "test1@gmail.com", "123", "test1@gmail.com", "09061234", "Ha noi", "", 100, datetime, datetime, 1, 1, 1));
            service.saveUser(new User(4, "B", "test2@gmail.com", "123", "test2@gmail.com", "09061234", "Ha noi", "", 100, datetime, datetime, 1, 1, 1));
            service.saveUser(new User(5, "C", "test3@gmail.com", "123", "test3@gmail.com", "09061234", "Ha noi", "", 100, datetime, datetime, 1, 1, 1));
            ...
            service.saveRequest(3, 2, "anh ơi cho em xin món này", "2021-10-05", "2021-10-05");
            service.saveRequest(2, 3, "cho em xin món này", "2021-10-06", "2021-10-06");
            service.saveRequest(3, 4, "em xin", "2021-10-07", "2021-10-07");
            service.saveRequest(2, 5, "món này ngon quá", "2021-10-08", "2021-10-08");
            service.saveRequest(3, 6, "em xin với ạ", "2021-10-09", "2021-10-09");
            service.saveRequest(2, 7, "em xin cho bữa tối ạ", "2021-10-10", "2021-10-10");
            service.saveRequest(3, 8, "em cho bé bán vé số ạ", "2021-10-11", "2021-10-11");
            service.saveRequest(2, 9, "help", "2021-10-12", "2021-10-12");
            service.saveRequest(3, 10, "em xin với ạ", "2021-10-13", "2021-10-13");

            service.saveRequest(2, 17, "cho em xin bữa này với ạ", "2021-10-14", "2021-10-14");
            service.saveRequest(3, 18, "nhìn ngon quá cho em xin món này vs ạ", "2021-10-15", "2021-10-15");
            service.saveRequest(2, 19, "món này ngon quá", "2021-10-16", "2021-10-16");
            service.saveRequest(3, 20, "em xin với ạ", "2021-10-17", "2021-10-17");

            service.saveRequest(2, 42, "món này ngon quá", "2021-10-18", "2021-10-18");
            service.saveRequest(3, 43, "cho em xin món này đi đại ca", "2021-10-19", "2021-10-19");
            service.saveRequest(2, 44, "cho em xin bữa này với ạ", "2021-10-20", "2021-10-20");
            service.saveRequest(3, 45, "em xin với ạ", "2021-10-21", "2021-10-21");
            service.saveRequest(2, 46, "món này ngon quá", "2021-10-25", "2021-10-25");
            service.saveRequest(3, 47, "cho em xin món này đi đại ca", "2021-10-26", "2021-10-26");

            service.saveRequest(2, 81, "em xin", "2021-11-02", "2021-11-02");
            service.saveRequest(3, 81, "anh ơi cho em xin món này", "2021-11-02", "2021-11-02");

            service.saveRequest(2, 82, "cho em xin món này", "2021-11-03", "2021-11-03");
            service.saveRequest(3, 82, "em xin", "2021-11-03", "2021-11-03");

            service.saveRequest(2, 83, "món này ngon quá", "2021-11-04", "2021-11-04");
            service.saveRequest(3, 83, "em xin với ạ", "2021-11-04", "2021-11-04");

            service.saveRequest(2, 84, "em xin cho bữa tối ạ", "2021-11-05", "2021-11-05");
            service.saveRequest(3, 84, "em cho bé bán vé số ạ", "2021-11-05", "2021-11-05");

            service.saveRequest(2, 85, "help", "2021-11-06", "2021-11-06");
            service.saveRequest(3, 85, "em xin với ạ", "2021-11-06", "2021-11-06");

            service.saveRequest(2, 86, "cho em xin bữa này với ạ", "2021-11-07", "2021-11-07");
            service.saveRequest(3, 86, "nhìn ngon quá cho em xin món này vs ạ", "2021-11-07", "2021-11-07");

            service.saveRequest(2, 87, "món này ngon quá", "2021-11-08", "2021-11-08");
            service.saveRequest(3, 87, "em xin với ạ", "2021-11-08", "2021-11-08");

            service.saveRequest(2, 88, "món này ngon quá", "2021-11-09", "2021-11-09");
            service.saveRequest(3, 88, "cho em xin món này đi đại ca", "2021-11-09", "2021-11-09");

            service.saveRequest(2, 89, "cho em xin bữa này với ạ", "2021-11-10", "2021-11-10");
            service.saveRequest(3, 89, "em xin với ạ", "2021-11-10", "2021-11-10");

            service.saveRequest(2, 90, "món này ngon quá", "2021-11-07", "2021-11-07");
            service.saveRequest(3, 90, "cho em xin món này đi đại ca", "2021-11-07", "2021-11-07");

            service.saveRequest(2, 91, "món này ngon quá", "2021-11-03", "2021-11-03");
            service.saveRequest(3, 91, "cho em xin món này đi đại ca", "2021-11-03", "2021-11-03");

            service.saveRequest(2, 92, "cho em xin bữa này với ạ", "2021-11-04", "2021-11-04");
            service.saveRequest(3, 92, "em xin với ạ", "2021-11-04", "2021-11-04");

            service.saveRequest(2, 93, "món này ngon quá", "2021-11-05", "2021-11-05");
            service.saveRequest(3, 93, "em xin với ạ", "2021-11-05", "2021-11-05");

            service.saveRequest(2, 94, "cho em xin bữa này với ạ", "2021-11-07", "2021-11-07");
            service.saveRequest(3, 94, "cho em xin món này đi đại ca", "2021-11-07", "2021-11-07");

            service.saveRequest(2, 95, "món này ngon quá", "2021-11-08", "2021-11-08");
            service.saveRequest(3, 95, "em xin với ạ", "2021-11-08", "2021-11-08");

            service.saveRequest(2, 96, "cho em xin bữa này với ạ", "2021-11-08", "2021-11-08");
            service.saveRequest(3, 96, "cho em xin món này đi đại ca", "2021-11-08", "2021-11-08");

            service.saveRequest(2, 97, "cho em xin bữa này với ạ", "2021-11-03", "2021-11-03");
            service.saveRequest(3, 97, "nhìn ngon quá cho em xin món này vs ạ", "2021-11-03", "2021-11-03");

            service.saveRequest(2, 98, "cho em xin bữa này với ạ", "2021-11-08", "2021-11-08");
            service.saveRequest(3, 98, "cho em xin món này đi đại ca", "2021-11-08", "2021-11-08");

            service.saveRequest(2, 99, "món này ngon quá", "2021-11-04", "2021-11-04");
            service.saveRequest(3, 99, "em xin với ạ", "2021-11-04", "2021-11-04");

            service.saveRequest(2, 100, "cho em xin bữa này với ạ", "2021-11-03", "2021-11-03");
            service.saveRequest(3, 100, "nhìn ngon quá cho em xin món này vs ạ", "2021-11-04", "2021-11-04");

            service.saveRequest(2, 101, "nhìn ngon quá cho em xin món này vs ạ", "2021-11-12", "2021-11-12");
            service.saveRequest(3, 101, "nhìn ngon quá", "2021-11-11", "2021-11-11");

            service.saveRequest(2, 102, "món này ngon quá", "2021-11-11", "2021-11-11");
            service.saveRequest(3, 102, "cho em xin bữa này với ạ", "2021-11-11", "2021-11-11");

            service.saveRequest(2, 103, "món này ngon quá", "2021-11-10", "2021-11-10");
            service.saveRequest(3, 103, "em xin với ạ", "2021-11-11", "2021-11-11");

            service.saveRequest(2, 104, "nhìn ngon quá cho em xin món này vs ạ", "2021-11-10", "2021-11-10");
            service.saveRequest(3, 104, "em xin với ạ", "2021-11-10", "2021-11-10");

            service.saveRequest(2, 105, "nhìn ngon quá cho em xin món này vs ạ", "2021-11-08", "2021-11-08");
            service.saveRequest(3, 105, "cho em xin bữa này với ạ", "2021-11-08", "2021-11-08");

            service.saveRequest(2, 106, "món này ngon quá", "2021-11-08", "2021-11-08");
            service.saveRequest(3, 106, "nhìn ngon quá cho em xin món này vs ạ", "2021-11-08", "2021-11-08");
