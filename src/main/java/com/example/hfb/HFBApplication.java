    ...
    CommandLineRunner runner(SeedingService service) {
        return args -> {
           ...
           // add user
            ...
            service.saveUser(new User(4, "B", "test2@gmail.com", "121199abcd", "test2@gmail.com", "09061234", "Ha noi", "v1636104837/hanoi_food_bank_project/users_avatar/volunteer.png", 100, datetime, datetime, 1, 1, 1, 105.845705d, 21.004627d));
